...
def _expr(expr: dt.Expr, stmts: list[TypedTopLevel], arguments: tuple[analysis.ModifiedName, ...]) \
    ...
    match type(expr):
        ...
        case dt.Abstraction:
            ...
            body, code, used1 = _expr(expr.body, stmts, arguments + (modified,))
...
def compile_typed(expr: dt.Expr, stmts: list[TypedTopLevel], arguments: tuple[analysis.ModifiedName, ...])\
